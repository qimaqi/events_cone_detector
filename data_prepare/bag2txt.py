...
parser.add_argument("--event_topic", default="/cam0/events", help="Event topic")  # /dvs/events
parser.add_argument("--image_topic", default="/cam0/image_raw", help="Image topic")
parser.add_argument("--depthmap_topic", default="/cam0/depthmap", help="Depth map topic")
parser.add_argument("--imu_topic", default="/cam0/imu", help="IMU topic")
parser.add_argument("--calib_topic", default="/cam0/camera_info", help="Camera info topic")
